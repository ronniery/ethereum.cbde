...
contract Deposit {
    ...
    function transferEther(address payable recipient, uint amount) public returns (bool) {
        /**
         * Require function is able to do some validations, verifying for wether or not a condition
         * is true/false, if it is "true" it will continue the function flow, otherwise it will throw
         * an error, using the message provided on the exception.
         */
